class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "93f62871a287bb4faacb7ed0d4893cdf788f8eabbcac8735fb3c01484e4d5881"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "732810da38ee70152c985664cba5958df4dd00d617c3e0459e965cf7686d89a9"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "df11be7499ff99a466ff7c6b998677c373b31c2ee845198d7a2ac3fca148c669"
  end
