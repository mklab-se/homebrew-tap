class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "71c62e3d0d5278be0c6a40b22281560047ae1328406f4fcc22986ac734b9ea8f"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "bb7b17e4316bb34d7c41f68babab532cb997ef4b889d1c0858ac47075b65679f"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "e620bc02f398f00a7c6bf829ab56760876e2140445e37f06b70391572b2b37ed"
  end
