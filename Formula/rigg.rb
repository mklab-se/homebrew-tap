class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "f80dc780bfeb5cf640a03a7311915876d84c4cb6b79cb9681d9f218374448a7d"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "529bba607520b2c9c2386df8e67a0b97395cc8d454e9a0ad0399824045e08acf"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "6540e6f3f3e90529843a256dcccae52313faf7ee673f65fdbaeb48d6ba180a2e"
  end
