class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "c1fa64d502b202a8ea36896e2dd3f98a5f90d7dd861b765855459f049fbf37d4"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "ea08227a7abb04cd777fefbca4a513ac5fe62566d775a2c5be6753afa4a678b1"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "0219e969c2c75485caf15291f51e5511593e410e9b296314bae018f67cbabe36"
  end
