class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "5cb895a3adb86d75dfdc92e30b15d7699b3b84c8d3a0f51a2af0a6315ad37c08"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "a7f188f2df82cf16c1373214e16d9e98347e5521a9d4a9939f0f2a90002f9564"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "7b5482b95f3932c3f6bd4fbfbe59e2ea43567206583766310644225d0f58aac0"
  end
