class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "51e88cd9c2c7d980d31c00876f1d16938f47278c0b77658833c31aa8f39a355e"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "9f6499685cd832390de2948a859150260639066a07be33cd96d849df356cc858"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "b61c9f6dc9efc26c5ffd2b61c0850d1b46912a8983fb42e5d5c82bcefe0cee2e"
  end
