class Rigg < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "100a65294fec3b505457212d06de129fc34e5cbe72f29ba217e60f8c5b463a3a"
    else
      url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "7f7ed754528edb919a332b7ab06c90a316e6c8a6c79506445efe5ef590613c58"
    end
  end

  on_linux do
    url "https://github.com/mklab-se/rigg/releases/download/v#{version}/rigg-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "b040826f599ed1a40ddb95b7a18248007589d1a67ddffedfe7bb72d895c51b74"
  end
